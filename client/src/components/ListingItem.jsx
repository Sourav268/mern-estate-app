...
export default function ListingItem({ listing }) {
  return( 
    ...
    <img src={listing.imageUrls[0] || "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQgtDLLfMP5UfQen-dRBGHXLZMzNwllJD4pkw&usqp=CAU"} 
