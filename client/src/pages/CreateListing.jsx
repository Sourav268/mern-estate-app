  ...
  return (
    <main className='p-3 max-w-4xl mx-auto'>
        ...
        <div className="flex flex-wrap gap-6">
            ...
            <div className='flex items-center gap-2'>
                <input className='p-3 border border-gray-300 rounded-lg' type='number' id='regularPrice' min='0' max='50000' 
                onChange={handleChange}
            ...
            {formData.offer && (
            <div className='flex items-center gap-2'>
                <input className='p-3 border border-gray-300 rounded-lg' type='number' id='discountPrice' min='0' max='50000' 
                onChange={handleChange}
        ...
        <div className="flex gap-4">
            ...
            className='p-3 border border-x-gray-300 rounded w-full' type='file' id='images' 
        ...
        <p className='text-red-700 text-sm'>{imageUploadError && imageUploadError}</p>    
        {
            formData.imageUrls.length > 0 && formData.imageUrls.map((url, index) => (
                ...
                className='p-3 text-red-700 rounded-lg uppercase hover:opacity-75 font-semibold'>Delete</button>
                </div>
            ))
        } 
